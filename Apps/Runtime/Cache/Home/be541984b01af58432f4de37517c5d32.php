...
<html lang="zh-cn">
	<head>
      	...
      	<title>团购 - <?php echo ($CONF['mallTitle']); ?></title>
     	...
     	<link rel="stylesheet" href="/Apps/Home/View/<?php echo ($WST_STYLE); ?>/css/group.css" />
...
<div class="headNav">
		...
		<div class="wst-slide" id="wst-slide">
			<div id="wst-group-slide-items" class="slideBox">
	
			  <ul class="items">
				<?php $_result=WSTAds(-8);if(is_array($_result)): $k = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li style="z-index: 1;  background: url(/<?php echo ($vo['adFile']); ?>) 50% 0% / cover no-repeat scroll;" onclick="addAccess(<?php echo ($vo['adId']); ?>);goBack(this)" data='<?php echo ($vo['adURL']); ?>'>
					<a target="_blank" onclick="addAccess(<?php echo ($vo['adId']); ?>)" href="<?php echo ($vo['adURL']); ?>"></a>
					</li><?php endforeach; endif; else: echo "" ;endif; ?>
			  </ul>
			</div>
		</div>
		<div id="wst-te-cat" class="wst-te-cat">
			<div class="catl"><span>团购分类</span></div>
			<div class="catr">
				<?php if(is_array($goodsCats)): $k1 = 0; $__LIST__ = $goodsCats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k1 % 2 );++$k1;?><span data="<?php echo ($vo['catId']); ?>"><?php echo ($vo['catName']); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
			</div>
			<div class="wst-clear"></div>
		</div>
		<?php if(is_array($goodsCats)): $k1 = 0; $__LIST__ = $goodsCats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k1 % 2 );++$k1;?><div id="wst-te-cat2_<?php echo ($vo['catId']); ?>" class="wst-te-cat2" style="display:none;">
			<div class="cats">
				<span>全部</span>
				<?php if(is_array($vo['childs'])): $k2 = 0; $__LIST__ = $vo['childs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k2 % 2 );++$k2;?><span data="<?php echo ($vo2['catId']); ?>"><?php echo ($vo2['catName']); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
				<div class="wst-clear"></div>
			</div>
		</div><?php endforeach; endif; else: echo "" ;endif; ?>
		<div class="wst-te-goods" id="wst-goods-list">
			<div class="wst-clear"></div>
		</div>
		<div id="wst-page" class="wst-goods-page"></div>
...
<div class="wst-footer-hp-box">
	...
	<script src="/Apps/Home/View/<?php echo ($WST_STYLE); ?>/js/group.js" type="text/javascript"></script>
	...
	<script>
		...
		$('#wst-group-slide-items').slideBox({
