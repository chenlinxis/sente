...
<html lang="zh-cn">
	<head>
      	...
      	<link rel="stylesheet" href="/Apps/Home/View/<?php echo ($WST_STYLE); ?>/css/regist.css">
     	<link rel="stylesheet" href="/Apps/Home/View/<?php echo ($WST_STYLE); ?>/css/passport.css">
		...
		<link rel="stylesheet" href="/Apps/Home/View/<?php echo ($WST_STYLE); ?>/css/head.css" />
     	<link rel="stylesheet" href="/Apps/Home/View/<?php echo ($WST_STYLE); ?>/css/footer.css">
   	</head>
   	<body>
...
<div class="wst-footer-hp-box">
    ...
    <script src="/Apps/Home/View/<?php echo ($WST_STYLE); ?>/js/common.js"></script>
    <script src="/Apps/Home/View/<?php echo ($WST_STYLE); ?>/js/regist.js"></script>
    <style>
