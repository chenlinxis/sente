...
<html lang="zh-cn">
   ...
   function login(){
	   ...
	   Plugins.waitTips({title:'信息提示',content:'正在登录，请稍后...'});
		$.post(Think.U("Admin/login/login"),params,function(data,textStatus){
   ...
   function getVerify() {
	   $('.verifyImg').attr('src',Think.U('Admin/Login/getVerify','rnd='+Math.random()));
   }
   </script>
   <body>
        <div id="loginbox"> 
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            ...
                            <label class="img">
			                	<img style='vertical-align:middle;cursor:pointer;height:31px;' class='verifyImg' src='/Apps/Home/View/default/images/clickForVerify.png' title='刷新验证码' onclick='javascript:getVerify()'/> 
							</label>
                        </div>
                    </div>
                </div>
