                    ...
                    <ul class="sidebar-menu">
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo U('Admin/Category/showlist');?>" target='pageContent'>商品分类</a></li>
					            <li><a href="<?php echo U('Admin/Brands/index');?>" target='pageContent'>品牌管理</a></li>
					            <li><a href="<?php echo U('Admin/Goods/showlist');?>" target='pageContent'>商品列表</a></li>
                        ...
                        <li class="treeview">
                            <a href="#">
                                <span>招聘管理</span>
                                <small id='' style='display:none' class="badge pull-right bg-green">0</small>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo U('Admin/Recruit/showlist');?>" target='pageContent'>招聘信息</a></li>
                                <li><a href="<?php echo U('Admin/Recruit/showlist');?>" target='pageContent'>招聘分类</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo U('Admin/Role/index');?>" target='pageContent'>角色管理</a></li>
                                <li><a href="<?php echo U('Admin/Staffs/index');?>" target='pageContent'>职员管理</a></li>
                                <li><a href="<?php echo U('Admin/Recruit/showlist');?>" target='pageContent'>登陆日志</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
