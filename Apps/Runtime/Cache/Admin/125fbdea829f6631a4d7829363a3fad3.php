...
<html lang="zh-cn">
   ...
   <body class='wst-page'>
       ...
       <a class="btn btn-success glyphicon glyphicon-plus"href="<?php echo U('Admin/Role/toEdit',array('id'=>$vo['role_id']));?>" style='float:right'>新增</a>
       </div>
      <div class="wst-body"> 
        <table class="table table-hover table-striped table-bordered wst-list">
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $i = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td>
               <a class="btn btn-default glyphicon glyphicon-pencil" href="<?php echo U('Admin/Role/toEdit',array('id'=>$vo['role_id']));?>">修改</a>&nbsp;
