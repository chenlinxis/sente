...
class RecruitModel extends BaseModel {
    /**
	 ...
	 public function insert(){
	 	...
	 	$id = (int)I("id",0);
		$data = array();
		$data["recruit_type_id"] = (int)I("recruit_type_id");
		$data["recruit_title"] = I("re_title");
		$data["recruit_job"] = I("re_job");
		$data["recruit_dept"] = I("re_dept");
		$data["recruit_position"] = I("re_position");
		$data["recruit_num"] = I("re_num");
		$data["isShow"] = (int)I("isShow",0);
		$data["recruit_desc"] = I("re_desc");
